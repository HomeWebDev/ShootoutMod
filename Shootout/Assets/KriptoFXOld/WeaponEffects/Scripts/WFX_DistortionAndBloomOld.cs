...
#endif
public class WFX_DistortionAndBloomOld : MonoBehaviour
{
    ...
    const string shaderName = "Hidden/KriptoFX/PostEffects/WFX_Bloom";
    const string shaderAdditiveName = "Hidden/KriptoFX/PostEffects/WFX_BloomAdditive";
